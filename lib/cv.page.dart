      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return Scaffold(
            ...
            appBar: AppBar(
              title: Text(
                isEnglishOn ? 'Bienvenue' : 'Welcome',
                style: TextStyle(fontSize: 25, color: isLightMode ? Colors.black : Colors.white),
              ),
            ...
            floatingActionButton: FloatingActionButton(
              ...
              mini: true, // Ajoutez cette ligne pour rendre le bouton plus petit
